...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'products/new', name: 'product-create', component: () => import('@/views/products/ProductFormView.vue'), meta: { title: '新增商品' } },
      { path: 'products/:id/edit', name: 'product-edit', component: () => import('@/views/products/ProductFormView.vue'), meta: { title: '编辑商品' } },
      ...
      { path: 'suppliers', name: 'suppliers', component: () => import('@/views/parties/SupplierListView.vue'), meta: { title: '供应商管理' } },
      { path: 'suppliers/new', name: 'supplier-create', component: () => import('@/views/parties/SupplierListView.vue'), meta: { title: '新增供应商', openCreate: true } },
      { path: 'customers', name: 'customers', component: () => import('@/views/parties/CustomerListView.vue'), meta: { title: '客户管理' } },
      ...
      { path: 'stocktaking', name: 'stocktaking', component: () => import('@/views/stocktaking/StocktakingView.vue'), meta: { title: '库存盘点' } },
