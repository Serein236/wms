  ...
  <div class="party-list-page">
    <div class="page-toolbar">
      <div class="page-toolbar-info">
        <h4><i class="bi bi-people me-2"></i>客户管理</h4>
        <p>查看、编辑、删除客户信息</p>
      </div>
      <button class="btn btn-primary btn-sm" @click="openCreate">
        <i class="bi bi-plus-circle me-1"></i>新增客户
      </button>
    </div>
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div class="search-box">
          ...
          <input v-model="searchQuery" type="text" class="form-control form-control-sm" placeholder="搜索客户名称...">
        </div>
      </div>
    ...
    <BaseModal v-model="showForm" :title="editing ? '编辑客户' : '新增客户'" size="lg">
      <div class="row g-3">
        <div class="col-md-4">
          <label class="form-label">客户名称 <span class="text-danger">*</span></label>
          <input v-model="form.name" type="text" class="form-control" required placeholder="客户名称">
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
          ...
          <input v-model="form.remark" type="text" class="form-control" placeholder="备注">
        </div>
      </div>
      <template #footer>
    ...
    <ConfirmDialog ref="deleteConfirm" title="删除客户" type="danger" confirm-text="删除" />
  </div>
</template>
...
function openCreate() {
  editing.value = null
  form.value = { name: '', contact_person: '', phone: '', email: '', address: '', remark: '' }
  showForm.value = true
}
